...
class _AccountInformationState extends State<AccountInformation> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Account", style: GoogleFonts.inter(fontSize: 50, fontWeight: FontWeight.w700, color: CustomColor.defaultColor, height: 1.0,)),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
              color: selected ? CustomColor.defaultColor : Colors.transparent,
              width: 2,
            ),
          ),
        ),
        child: Text(
          label,
          style: TextStyle(
            color: selected ? CustomColor.defaultColor : Colors.grey,
  ...
  Widget _buildActionList(Size size) {
    return Expanded(
      child: ListView(
        children: [
          _menuItem(Icons.account_balance_wallet, 'Deposit', onPressed: () => Get.to(() => Deposit())),
          ...
          _menuItem(Icons.money_off, 'Withdrawal', onPressed: () => Get.to(() => Withdrawal())),
