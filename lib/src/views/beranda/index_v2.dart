  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Obx(
          () => CupertinoButton(
            onPressed: tradingController.tradingAccountModels.value?.response.real?.length == 0 ? null : (){
            ...
            child: Row(
              children: [
                CircleAvatar(backgroundImage: AssetImage('assets/images/logo-rrfx.png'), radius: 20, backgroundColor: Colors.white),
